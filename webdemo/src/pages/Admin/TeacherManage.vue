<template>
  <div class="all">
    <p style="margin:0; font-size:25px;">教师管理</p>
...
export default {
  ...
  methods: {
    getStudentInfo() {
      //分页查询所有老师信息
      this.$store.dispatch('getTeacherAll').then(res=>{
        this.pagination.records = this.$store.state.user.teacher;
